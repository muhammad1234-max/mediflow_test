...
function LoginPage() {
  ...
  const [email, setEmail] = useState(role === "admin" ? "admin@mediflow.io" : "staff@mediflow.io");
      ...
      <div className="flex items-center justify-center p-6 sm:p-12">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2 p-1 rounded-xl bg-muted">
            {(["admin", "staff"] as const).map((r) => (
              <button
                ...
                onClick={() => {
                  setRole(r);
                  setEmail(r === "admin" ? "admin@mediflow.io" : "staff@mediflow.io");
                }}
          ...
          <p className="text-xs text-center text-muted-foreground">
            Demo mode — use admin@mediflow.io / demo or staff@mediflow.io / demo.
          </p>
        </motion.form>
      </div>
    </div>
